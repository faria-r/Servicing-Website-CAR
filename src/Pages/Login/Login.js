    ...
    <h1 className="text-5xl text-center font-bold">Login now!</h1>
      ...
      <div className="card-body ">
        ...
        <div className="form-control mt-6">
            <input className='btn btn-outline mb-3 btn-primary' type="submit" value="Login" />
            <input onClick={handleLogInWithGoogle} className='btn btn-outline btn-warning' type="submit" value="Login With Google" />
        </div>
      </form>
      <p className='py-5'>
    Don't have a Account? <Link className='text-orange-600 font-bold text-xl' to='/register'>Register</Link>
      </p>
    </div>
  </div>
</div>
